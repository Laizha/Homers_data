...
When viewing all of the graphs and random sample size in each graph, there is a pattern that slowly agrees with the theory of CLT. The central limit theorem shows how the mean and standard deviation and takes ssamples from the graphs and or situations/questions with replacement, then shows us the distribution of the sample means which will be approximately and normally distributed.